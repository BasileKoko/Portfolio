...
-------------- | -----------------------------------------------| ----------------------|------------- |--------|--------
[Github Favourite Programming Language App](https://github.com/BasileKoko/python_script) | A command line App which allows users to enter a GitHub username, and to be presented with the GitHub user's favourite programming language. | 2 days | Python, Github API | Pytest | N/A
